...
/* tslint:disable */
/* eslint-disable */
import type { BomItemSubstitute } from './BomItemSubstitute';
import type { Category } from './Category';
import type { PartBrief } from './PartBrief';
/**
 * Serializer for BomItem object.
 */
export type PatchedBomItem = {
    /**
    ...
    readonly sub_part_detail?: PartBrief | null;
    readonly pricing_min?: string | null;
    readonly substitutes?: Array<BomItemSubstitute> | null;
